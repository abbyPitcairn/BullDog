...
public class PlayerListModel {
    ...
    protected static PlayerListModel initializePlayers() {
        ...
        for (int i = 0; i < numPlayers; i++) {
            ...
            String[] options = {"Human", "Random", "Variable", "Unique", "Wimp"};
            ...
            if (choice == 2) { 
                while (true) {
                    String input = JOptionPane.showInputDialog(null, "Choose limit for " + name + ":", "Limit", JOptionPane.QUESTION_MESSAGE);
                    try {
                        limit = Integer.parseInt(input);
                        break;
                    } catch (NumberFormatException e) {
                        JOptionPane.showMessageDialog(null, "Please enter a valid integer limit.");
                    }
                }
            }
            switch (choice) {
                ...
                case 2 -> playerListModel.addPlayer(new VariablePlayer(name, limit));
